...
source $steps/results_dir.sh fastqc trimgalore kallisto
...
# kallisto
sbatch --export=ALL -J "$name"_kallisto -D $kallisto_out -o $logs_dir/%x_%j.out \
       	-d afterok:$trimgalore_jid $steps/kallisto.sh $file $file2
